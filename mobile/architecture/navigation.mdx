...
<Note>
  ...
  `NAVIGATION_CONFIG.PUBLIC_GROUPS`: `(onboarding)` y `(auth)`. La invitacion de chat
  (`chat/invite`) tambien se abre sin sesion: `useNavigation` la exime de la redireccion a login.
</Note>
