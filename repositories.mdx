...
| **Docs wiki** | Documentado nativamente en este repo (`docs`), ya que `vivla-api` no aloja su propia carpeta de docs. Ver [tab Vivla API](/backend/index) y las páginas de producto en [Operativa](/operativa/index). |
...
| vivla-api | 7 | Activo (nativo en repo `docs`) |
