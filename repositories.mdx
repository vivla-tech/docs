...
<Card title="vivla-tools" icon="wrench" href="https://github.com/vivla-tech/vivla-tools">
  Monorepo de herramientas internas: chat de soporte, community guidelines, surveys, notificaciones.
</Card>
...
| | |
|---|---|
| **Propósito** | Suite de herramientas internas con permisos jerárquicos, gestión de equipos y arquitectura modular. |
...
| **Apps** | `apps/frontend` (panel), `apps/backend` (API), `apps/community-frontend` (portal público), `apps/home-excellence` (portal propietarios) |
| **Conexiones** | Consumido por vivla-mobile-app (chat, surveys). Community Frontend y Home Excellence son portales públicos. |
| **Características** | Turborepo + pnpm workspaces, packages compartidos (common, ui, eslint-config) |
| **Docs wiki** | 24 páginas MDX — [Ver tab Tools](/tools/index) |
